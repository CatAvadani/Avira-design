...
export default function Footer() {
  return (
    <div className=' h-full bg-[#11041d] w-full text-white grid grid-cols-1 sm:grid-cols-5 row-span-3 sm:grid-rows-4'>
      ...
      <div className=' flex flex-col sm:flex-row gap-8 justify-between items-center col-span-1 sm:col-span-5 row-span-1 border-t border-white/30 h-full py-8 px-4 lg:px-28'>
